...
%changelog
* Sun Dec 05 2021 Mikhail Gavrilov <mikhail.v.gavrilov@gmail.com>
- Mesa developers moved "classic" drivers to "amber" branch so we need build from "master" without "classic" drivers
- Fixed typo LDFLAGS
