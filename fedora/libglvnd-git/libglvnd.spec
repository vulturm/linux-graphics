...
%global build_repo https://gitlab.freedesktop.org/glvnd/libglvnd
%define version_string 1.2.0

%define commit 58f1c0db95e060ae47faae9d556a48bf459558bd
...
License:        MIT
URL:            %{build_repo}
Source0:        %{build_repo}/-/archive/%{commit}/%{name}-%{commit}.tar.gz
