%global pkg_name pesign
%global build_branch master
%global build_repo https://github.com/vathpela/%{pkg_name}

%global maj_ver %(curl -s https://raw.githubusercontent.com/vathpela/%{pkg_name}/%{build_branch}/Make.version | grep MAJOR_VERSION | grep -oP '[0-9]+')
...
%prep
#%setup -q -T -b 0
%setup -q -T -D -c -n pesign-master/ -a 1
git init
...
%changelog
* Thu Aug 15 2019 Mihai Vultur <xanto@egaming.ro>
